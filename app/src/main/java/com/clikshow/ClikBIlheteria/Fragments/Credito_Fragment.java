...
import com.clikshow.ClikBIlheteria.Impressora.Lista_Impressoras_BlueTooth;
import com.clikshow.ClikBIlheteria.Services.Bilheteria_Service;
import com.clikshow.ClikBIlheteria.Views.View_Ingresso_Impressora;
...
public class Credito_Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_credito_bilheteria, container, false);
        ...
        acrescimo_pagar.setText("acréscimo de 5%");
        preco_pagar.setText("R$ "+ APIServer.preco(cartao));


        button_pagar = (Button) rootView.findViewById(R.id.button_pagar_credito);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.button_pagar_credito:
                                                                ...
                                                                alert_buy_success.setPositiveButton("Imprimir", new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            intent.putExtra("tipo_ingresso", 2);
